...
FINAL_IMAGE=${DISTDIR}/Thermostat.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=Thermostat_main.asm

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Thermostat_main.o
POSSIBLE_DEPFILES=${OBJECTDIR}/Thermostat_main.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Thermostat_main.o

# Source Files
SOURCEFILES=Thermostat_main.asm
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/Thermostat.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC18F46K42
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/Thermostat.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/Thermostat_main.o: Thermostat_main.asm  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Thermostat_main.o 
	${MP_AS} -mcpu=PIC18F46K42 -c \
	-o ${OBJECTDIR}/Thermostat_main.o \
	Thermostat_main.asm \
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/Thermostat.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC18F46K42 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/Thermostat.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
